...
- Orders data (SQL Server): localhost,5432;Database=Microsoft.eShopOnContainers.Services.OrderingDb;USER Id=SA;Password=Pass@word;
- Catalog data (SQL Server): localhost,5434;Database=CatalogDB;USER Id=SA;Password=Pass@word
